    ...
    return (
        <div className="App">
            <div className="mx-auto">
                ...
                <div className="w-screen bg-[#D4D0D0] h-32 flex items-center banner-img">
                    <div className="basis-9/12 flex items-center 2xl:text-4xl xl:text-3xl md:text-2xl sm:text-xl">
                    ...
                    <div className="basis-3/12 2xl:text-5xl xl:text-4xl md:text-3xl sm:text-2xl">
                        THE ROW
                    </div>
                </div>
            </div>
